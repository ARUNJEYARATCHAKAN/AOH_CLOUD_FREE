...
define view entity ZAP_C_BOOKING_REQ_01
  as projection on ZAP_I_BOOKING_M_01
{
      @UI.facet: [ { id:            'Booking',
                     purpose:       #STANDARD,
  ...
  key booking_id                as BookingID,
      ...
      @Search.defaultSearchElement: true // OK
      ...
      /* Associations */
      _Travel         : redirected to parent ZAP_C_TRAVEL_REQ_01,
      _BookSupplement : redirected to composition child ZAP_C_BOOKSUP_REQ_01,
      _Customer,
      _Carrier,
      _BookingStatus
